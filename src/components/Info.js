...
const Info = ({info}) => {
    ...
    const {strArtistThumb, strGenre, strBiographyES, strBiographyEN, strFacebook, strTwitter, strLastFMChart } = info;
    ...
    return ( 
        <div className="card border-light">
            ...
            <div className="card-body">
                ...
                <p className="card-text">Género: { (strGenre) ? strGenre : 'No se encontraron datos'}</p>
